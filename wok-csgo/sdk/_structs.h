...
enum e_contents_flags {
	...
	CONTENTS_TEAM1				= (1 << 11),
	CONTENTS_TEAM2				= (1 << 12),
	CONTENTS_IGNORE_OPAQUE	= (1 << 13),
	CONTENTS_MOVEABLE			= (1 << 14),
	CONTENTS_AREAPORTAL		= (1 << 15),
	CONTENTS_PLAYERCLIP		= (1 << 16),
	CONTENTS_MONSTERCLIP		= (1 << 17),
	CONTENTS_CUR_0				= (1 << 18),
	CONTENTS_CUR_90			= (1 << 19),
	CONTENTS_CUR_180			= (1 << 20),
	CONTENTS_CUR_270			= (1 << 21),
	CONTENTS_CUR_UP			= (1 << 22),
	CONTENTS_CUR_DOWN			= (1 << 23),
...
enum e_6mask_mode {
	...
	MASK_VISIBLE					= MASK_OPAQUE | CONTENTS_IGNORE_OPAQUE,
	MASK_VISIBLE_AND_NPCS		= MASK_OPAQUE_AND_NPCS | CONTENTS_IGNORE_OPAQUE,
	...
	MASK_PLAYERSOLIDBRUSHONLY	= CONTENTS_SOLID | CONTENTS_MOVEABLE | CONTENTS_WINDOW | CONTENTS_PLAYERCLIP | CONTENTS_GRATE,
	MASK_NPCSOLID_BRUSHONLY		= CONTENTS_SOLID | CONTENTS_MOVEABLE | CONTENTS_WINDOW | CONTENTS_MONSTERCLIP | CONTENTS_GRATE,
	MASK_NPCWORLDSTATIC			= CONTENTS_SOLID | CONTENTS_WINDOW | CONTENTS_MONSTERCLIP | CONTENTS_GRATE,
	MASK_NPCWORLDSTATIC_FLUID	= CONTENTS_SOLID | CONTENTS_WINDOW | CONTENTS_MONSTERCLIP,
	MASK_SPLITAREAPORTAL			= CONTENTS_WATER | CONTENTS_SLIME,
	MASK_CURRENT					= CONTENTS_CUR_0 | CONTENTS_CUR_90 | CONTENTS_CUR_180 | CONTENTS_CUR_270 | CONTENTS_CUR_UP | CONTENTS_CUR_DOWN,
	MASK_DEADSOLID					= CONTENTS_SOLID | CONTENTS_PLAYERCLIP | CONTENTS_WINDOW | CONTENTS_GRATE,
	MASK_SHOT_PLAYER				= MASK_SHOT_HULL | CONTENTS_HITBOX
};

enum e_event_state {
	EVENT_DEBUG_ID_INIT = 42,
	EVENT_DEBUG_ID_SHUTDOWN = 13,
};

enum e_handle_flags {
	ENTRY_BITS_COUNT			= 11 + 2,
	SERIAL_BITS_COUNT			= 16,
	ENTITY_ENTRIES_COUNT		= (1 << SERIAL_BITS_COUNT),
...
enum e_glow_style {
	GLOWSTYLE_DEFAULT,
	GLOWSTYLE_RIM_GLOW_3D,
	GLOWSTYLE_EDGE_HIGHLIGHT,
	GLOWSTYLE_EDGE_HIGHLIGHT_PULSE,
	GLOWSTYLE_COUNT,
};